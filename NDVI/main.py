...
image_directory = r"C:\Users\Krause\OneDrive\Dokumente\Sensorsysteme\Bilder_ersterLauf"  # Passe den Pfad zum Verzeichnis an
...
with open(output_file, 'w') as f:
    ...
    for filename in os.listdir(image_directory):
        if filename.endswith(".jpg") or filename.endswith(".png"):  # Nur Bilddateien berücksichtigen
            ...
            cut = to_cut_image(image, 345, 950, 30, 680)
